...
<p style="display:flex; gap:12px; align-items:center;">
  <img src="examples/video_1.gif" alt="Drone Detection Example 1" width="250" />
  <img src="examples/video_3.gif" alt="Drone Detection Example 3" width="250" />
  <img src="examples/video_2.gif" alt="Drone Detection Example 2" width="250" />
</p>
